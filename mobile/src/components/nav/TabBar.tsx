...
export function TabBar({ state, navigation }: BottomTabBarProps) {
  ...
  // Account opens from the header but lives under Workout, the way the
  // web's /client/settings keeps the nav's Workout tab lit.
  const currentName = state.routes[state.index]?.name;
  const activeName = currentName === 'account' ? 'index' : currentName;
